...
class Vessel(SimulationEngineAware):
    ...
    def __init__(self, capacities_and_loading_rates, location, keep_journey_log=True, name=None):
        """
        ...
        :param bool keep_journey_log: If true the vessel keeps a log of event occurrences that affected the vessel.
        :param str name: The name of the vessel.
        """
        super().__init__()
...
class SimpleVessel(Vessel):
    ...
    def __init__(self, capacities_and_loading_rates, location, speed, keep_journey_log=True, name=None):
        """
        :param capacities_and_loading_rates: A list of the types, capacities and loading rates of the cargo containers.
        :type capacities_and_loading_rates: List[CargoCapacity]
        :param location: The location of the vessel at creation.
        ...
        :type name: str
        """
        super().__init__(capacities_and_loading_rates, location, keep_journey_log=keep_journey_log, name=name)
        self._speed = speed
...
class SimpleCompany(ShippingCompany[V]):
    ...
    def apply_schedules(schedules):
        ...
        :type schedules: Dict[Vessel, Schedule]
        :return: The rejected schedules.
        :rtype: Dict[Vessel, Schedule]
        """
        rejected_schedules = {}
        for one_vessel in schedules.keys():
            schedule_for_vessel = schedules[one_vessel]
            if schedule_for_vessel.verify_schedule():
                one_vessel.schedule = schedule_for_vessel
            else:
                rejected_schedules[one_vessel] = schedule_for_vessel
        return rejected_schedules
