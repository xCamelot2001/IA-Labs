...
from mable.simulation_space import UnitShippingNetwork, Port, Location
...
class ClassFactory:
    ...
    def generate_network(*args, **kwargs):
        """
        Generates a network (space). Default: py:class:`maritime_simulator.simulation_space.UnitShippingNetwork`.
        :param args:
            Positional args.
        :param kwargs:
            Keyword args.
    ...
    def generate_port(*args, **kwargs):
        """
        Generates a port. Default: py:class:`maritime_simulator.simulation_space.Port`.
        :param args:
            Positional args.
        :param kwargs:
            Keyword args.
    ...
    def generate_location(*args, **kwargs):
        """
        Generates a location. Default: py:class:`maritime_simulator.simulation_space.Location`.
        :param args:
            Positional args.
        :param kwargs:
            Keyword args.
