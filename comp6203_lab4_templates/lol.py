...
class Company5(TradingCompany):
    def _init_(self, fleet, name):
        """
        Initialize the company with a fleet and a name.
        """
        super()._init_(fleet, name)
    ...
    def create_bid(self, cost, trade, auction_ledger=None):
        ...
        """
        # 提高初始利润因子
        profit_factor = 0.8  # 初始利润因子，从0.5开始，提高竞标价格
    ...
    def receive(self, contracts, auction_ledger=None, *args, **kwargs):
        ...
        for contract in contracts:
            ...
            print(f"Trade {contract.trade}: Fulfilled={contract.fulfilled}, Penalty={contract.trade.penalty}")
